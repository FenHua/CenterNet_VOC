...
# 类的名字可以根据自己的数据集来命名
class AIRCRAFT(DETECTION):
    def __init__(self, db_config, split):
        super(AIRCRAFT, self).__init__(db_config)
        ...
        self._coco_dir = os.path.join(data_dir, "aircraft")
        ...
        self._cache_file = os.path.join(cache_dir, "aircraft_{}.pkl".format(self._dataset))
        self._load_data()
